...
(function (ng) {
    ...
    //public
    var validationService = function (ajaxService, settings) {
    ...
    ng.module('services').service('validationService', ['ajaxService', validationService]);
