...
//  var scriptpath = getScriptPath();
  ...
  var _globaloptions = {
      ...
      railoffset: { top: 0, right: 0, left: -5, bottom: 0 },
      bouncescroll:true,
      spacebarenabled: true,
      railcolor: "rgb(0, 174, 239)",
...
//inspired by http://forum.jquery.com/topic/width-includes-border-width-when-set-to-thin-medium-thick-in-ie
    ...
    this.getOffset = function() {
      ...
      if (!self.viewport) return (self.win.offset() - self.win.scrollTop());
...
*/
      ...
      if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
        ...
        rail.css({ width: rail.width + "px", 'zIndex': self.zindex, "background": self.opt.background, cursor: "default", "margin-left": self.opt.railoffset.left, "margin-top": self.opt.railoffset.top });
...
//        self.checkrtlmode = true;
    ...
    this.onResize = function(e,page) {
      ...
      self.cursorheight -= self.opt.railpadding.top + self.opt.railpadding.bottom;

      self.cursorheight = self.opt.cursormaxheight && self.cursorheight > self.opt.cursormaxheight ? self.opt.cursormaxheight : self.cursorheight;
